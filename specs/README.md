...
| `path-preselection` | Home = full one-column tree with 3 path buttons (Full / Graph×LLM / AI systems); “Extrapolons” removed from all published pages; `curriculum.html` merged into home | pending PR | in review |
