#!/usr/bin/env python3
"""Verification + commit des intros P2 lot 2."""
import re, html.parser, os, subprocess

mods = ['m1p2-computer-vision-applications', 'm1p2-statistics-in-action',
        'm1p2-realtime-ai-videogames', 'm1p2-advanced-deep-learning', 'm1p2-optimization-ai']
...
if not issues:
    ...
    msg = ('Rework SynapseS P2 lot 2: CV-FFA/Stats/VideoGames/AdvDL/Optimization '
           '(AdvDL 38.25h programme 9 themes, evals officielles, absences parcours documentees)')
